...
function wp_lr_recover_password(){
    ...
    wp_lr_send_recover_password_email($email,$recover_email_link);
...
function wp_lr_send_recover_password_email($email,$recover_email_link){
    ...
    wp_lr_add_recover_token($email,$recover_email_link);
        wp_send_json([
            'success'=>true,
...
function wp_lr_add_recover_token($email,$recover_email_link){
    global $wpdb;
