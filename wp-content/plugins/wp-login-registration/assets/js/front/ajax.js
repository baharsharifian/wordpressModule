    ...
    $('.lr_login').on('submit', function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    $('#error-handler').removeClass('alert-danger').addClass('alert-success').text(response.message);
                    $('#lr-loading').html('<div class="lds-facebook"><div></div><div></div><div></div></div>');
                    setTimeout(function () {
            ...
            error: function (error) {
                if (error.responseJSON.error) {
                    $('#error-handler').removeClass('alert-success').addClass('alert-danger').text(error.responseJSON.message);
